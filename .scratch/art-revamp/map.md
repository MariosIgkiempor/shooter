...
- [Weapon shape and reconcile weapon-action-feel](issues/02-weapon-shape-and-reconcile-weapon-action-feel.md): distinct silhouette per weapon family (Gun=rod, Melee=wedge, Magic=rod+orb). **Amended by [ADR-0018](../../docs/adr/0018-weapon-visual-identity-is-per-kind-not-per-family.md)**: silhouettes are now per-*kind* (all eight), in the UI and the world, differing by countable geometry rather than proportion; effect shapes stay per-family, effect magnitudes vary per kind. Enhanced shape-based particle effects (a new streak kind, a new one-shot flash kind, non-linear fades) confirmed to supply the "punch" weapon-action-feel found plain icon-transform lacking — today's existing dot-only particles remain insufficient, confirming the gap was in the particle *vocabulary*, not shapes as a category. Amends weapon-action-feel's locked "new art assumed needed" decision. Prototype: [Weapon Effects Bench](https://claude.ai/code/artifact/3acfe471-59f9-4fe7-a171-dbd7bd97f6f9).
